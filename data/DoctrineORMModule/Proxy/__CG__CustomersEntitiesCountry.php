 ...
 */
class Country extends \Customers\Entities\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'shortName', '' . "\0" . 'Customers\\Entities\\Country' . "\0" . 'countryImage', 'dateCreated', 'createdBy', 'dateChanged', 'changedBy', 'dateDeleted', 'deletedBy', 'deleted'];
        }
    ...
    public function getCountryImage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCountryImage', []);

        return parent::getCountryImage();
    }
    ...
    public function setCountryImage($countryImage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCountryImage', [$countryImage]);

        return parent::setCountryImage($countryImage);
    }
